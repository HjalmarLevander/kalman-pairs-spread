...
_Auto-updated by `scripts/alpaca_paper_trade.py` -- last run 2026-08-31._
...
- **Days into evaluation window**: 9 / 90 (81 remaining before a go/no-go is even eligible)
- **Account equity**: $100,023.66

## Open positions

| symbol | side | qty | market value |
|---|---|---|---|
| KO | long | 82.328068996 | $7,328.84 |
| PEP | short | -51 | $-7,112.46 |
