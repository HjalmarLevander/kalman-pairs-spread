...
_Auto-updated by `scripts/alpaca_paper_trade.py` -- last run 2026-09-10._
...
- **Days into evaluation window**: 19 / 90 (71 remaining before a go/no-go is even eligible)
- **Account equity**: $100,090.12

## Open positions

| symbol | side | qty | market value |
|---|---|---|---|
| KO | long | 82.328068996 | $7,304.97 |
| PEP | short | -51 | $-6,975.78 |
