...
_Auto-updated by `scripts/alpaca_paper_trade.py` -- last run 2026-09-23._
...
- **Days into evaluation window**: 32 / 90 (58 remaining before a go/no-go is even eligible)
- **Account equity**: $99,773.73

## Open positions

| symbol | side | qty | market value |
|---|---|---|---|
| JBLU | long | 1225.636363637 | $5,466.22 |
| KO | short | -86 | $-7,640.24 |
| LUV | short | -152 | $-6,330.80 |
| PEP | long | 56.172853918 | $7,365.38 |
