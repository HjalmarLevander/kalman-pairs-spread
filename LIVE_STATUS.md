...
_Auto-updated by `scripts/alpaca_paper_trade.py` -- last run 2026-09-07._
...
- **Days into evaluation window**: 16 / 90 (74 remaining before a go/no-go is even eligible)
- **Account equity**: $100,021.43

## Open positions

| symbol | side | qty | market value |
|---|---|---|---|
| KO | long | 82.328068996 | $7,250.63 |
| MA | long | 9.279674126 | $5,374.88 |
| PEP | short | -51 | $-7,019.13 |
| V | short | -14 | $-5,250.98 |
