...
_Auto-updated by `scripts/alpaca_paper_trade.py` -- last run 2026-09-24._
...
- **Days into evaluation window**: 33 / 90 (57 remaining before a go/no-go is even eligible)
- **Account equity**: $99,720.27

## Open positions

| symbol | side | qty | market value |
|---|---|---|---|
| JBLU | long | 1225.636363637 | $5,374.42 |
| KO | short | -86 | $-7,665.18 |
| LUV | short | -152 | $-6,254.04 |
| PEP | long | 56.172853918 | $7,351.90 |
